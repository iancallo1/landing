  ...
  return (
    <Card className='mx-auto px-16 py-3 bg-background border border-0 w-96'>
      <CardHeader className="foreground">
        ...
        <CardTitle className={cn(f.variable, "font-sans text-white text-center text-5xl")}>WISE</CardTitle>
      </CardHeader>
      <CardContent>
          <form className="grid justify-center" onSubmit={handleSubmit}>
            ...
            <input className="rounded-md px-3 py-3 mb-5 w-full text-sm" type="password" name="password" placeholder="Password" required />
            <a href='' className="text-white mb-3">Forgot Password?</a>
            ...
            <a href='' className="text-white text-center">Signup</a>
          </form>
      </CardContent>
    </Card>
  );
